...
interface IAMOMinterV2 {
    ...
    function giveCollatToAMO(address collat_address, address destination_amo, uint256 collat_amount) external;
    function receiveCollatFromAMO(address collat_address, uint256 collat_amount) external;
